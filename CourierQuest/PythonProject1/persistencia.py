...
class SistemaPersistencia:
    ...
    def guardar_puntaje(self, nombre_jugador, puntaje_final, datos_extra=None):
    ...
    def calcular_puntaje_final(self, jugador, tiempo_total, duracion_objetivo, meta_ingresos):
        ...
        bonus_tiempo = 0
        tiempo_restante_porcentaje = (duracion_objetivo - tiempo_total) / duracion_objetivo
...
class HistorialMovimientos:
    ...
    def guardar_estado(self, jugador, pedidos_activos, tiempo):
        estado = {
            'jugador_x': jugador.x,
            'jugador_y': jugador.y,
